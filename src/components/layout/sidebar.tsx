              ...
              <>
                <li>
                  <Link
                    href="/settings/users"
                    prefetch={false}
                    className={`flex items-center px-3 py-2 rounded-md ${isActive('/settings/users') ? 'text-blue-600 bg-blue-50 font-medium' : 'text-gray-700 hover:bg-gray-100'
                      }`}
                  >
                ...
                <li>
                  <Link
                    ...
                    prefetch={false}
                    className={`flex items-center px-3 py-2 rounded-md ${isActive('/settings/corporate') ? 'text-blue-600 bg-blue-50 font-medium' : 'text-gray-700 hover:bg-gray-100'
                      }`}
                  >
